...
kbd:[AWSD] (and *Arrows* if `UseNumPad=False in 'settings.txt'`)::  Left, Right, Foreward, Backward.

* Move up (vertical) kbd:[W-Spacebar]
* Move down (vertical) kbd:[S-Spacebar].

Movement Speed:

* Std Speed is keyboard arrow keys only.
...
[NOTE] 
This thumbnail library is only for 64 bit systems only
