...
[TIP]
If your camera is looking down on terrain, you would also be flying down to terrain by using the arrow-key to move forward. If you press the period-key `.`( dot ), you are flying horizontally, and the camera is looking down. By pressing dot `.` a second time, you will get the standard-function back.
...
kbd:[Ctrl + Q]:: Toggle the "manual/auto" `add track to TDB` option (use Z key for manual).
...
b. You can perform advanced translation by pressing kbd:[T] and using kbd:[4,6,8,2] keys{DOT} to move in X and Z Axis, and kbd:[9,3] keys to move in Y axis.
c. You can adjust object rotation by pressing kbd:[R] and using kbd:[4,6,8,2] keys{DOT}.
