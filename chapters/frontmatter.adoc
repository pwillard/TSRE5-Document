...
==== The Full List of Settings Options Based on GITHUB Source Code:

ANY items marked with a comment "NEW" are recent additions and may or may not have an existing explanation of useage nor even any code to fully support it.  Use these new items with caution and the understanding that they may not work.
